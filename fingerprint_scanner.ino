...
void setup() {
  // fingerprint finger detect test
  Serial.begin(9600);
  //LED connection
  pinMode(5, OUTPUT);
  digitalWrite(5, LOW);
  ...
  //set data rate for sensor serial port
  finger.begin(57600);
...
//Enroll
  ...
  //returns -1 if failed, or return ID #
...
void loop()
{
  ...
  //I think it just stays here looping..
}
